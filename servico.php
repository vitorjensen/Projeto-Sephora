...
//$sql = "select * from tb_autenticacao where aut_codigo = '$codigo'";
...
?>
     ...
     ?>
      ...
      <main>
          <header>
              ...
              </svg></a>Dados de <?php echo $_SESSION['aut_nome_completo'] ?>:</h1>
          </header>
         <div class="card-body">

         <div class="container">
              <form  id="servico.php"  name="novo_cliente.php" action="atualizar_conta.php" method="POST">
                <div class="form-group">
                  <h2>Dados de Log-in:</h2>
                 <p>Altere apenas seus dados de Log-in!</p>
                  <hr></hr>
                  <br>
                  <br>
                  <br>
                  ...
                  <br>
                  <h2>Deletar conta:</h2>
                  <p>Sua conta deixará de existir permanentemente!</p>
                  <hr></hr>
                </div>
                <div class="form-group">
                    <label> Primeiro nome: </label>
                    <input type="text" class="form-control"  value="<?php echo $_SESSION['aut_nome_completo'] ?>" id="aut_nome_completo" name="aut_nome_completo" placeholder="Digite seu nome completo:" style="font-size: 16px;" readonly>
                
                    <label> Email: </label>
                    <input type="text" class="form-control" value="<?php echo $_SESSION['aut_email'] ?>" id="aut_email" name="aut_email" placeholder="Digite seu Email:" style="font-size: 16px;" readonly>
            <br>
            <div class="footer" style="text-align: center;">
            <button type="submit" value="Entrar" name="alterar" id="alterar" class="btn btn-primary" >
                    Alterar
                    </button>
                    </div>
                    ...
                    <div> 
                      ...
                      <div class="form-group">
                        ...
                        <div class="footer" style="text-align: center;">
                        <a id="excluir" class="btn btn-sm btn-ghost-danger" href="delete_usuario.php?aut_codigo=<?php echo $_SESSION['aut_codigo']; ?>"  onclick="excluir_registro(event)" title="Excluir">
                    Deletar
          </a>
                        </div>
                      </div>
  ...
  <script type="text/javascript">
    ...
    function excluir_registro( ) {
      ...
      window.prompt('Confime seu email:');
