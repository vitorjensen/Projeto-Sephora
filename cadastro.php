...
<body>
    ...
    <main>
        <header>
            ...
            </svg></a>REGISTRE-SE</h1>
        </header>
        <div class="card-body">
            <div class="container">
            <form name="frm_cadastro" action="cadastrar_cliente.php" method="post">
                <div class="form-group">
                    <label> Primeiro nome: </label>
                    <input type="text" class="form-control" id="txt_nome_completo" name="txt_nome_completo" placeholder="Digite seu nome completo:" style="font-size: 16px;">
                
                    <label> Email: </label>
                    <input type="text" class="form-control" id="txt_email" name="txt_email" placeholder="Digite seu Email:" style="font-size: 16px;">
                
                    <label> Telefone: </label>
                    <input type="text" class="form-control" id="txt_telefone" name="txt_telefone" placeholder="Digite seu telefone:" style="font-size: 16px;">
                
                    <label> Sexo: </label>
                   <select class="form-control" id="txt_sexo" name="txt_sexo" style="font-size: 16px; width: 300px; height: 40px;">
                   ...
                   <input type="date" class="form-control" id="txt_data_nascimento" name="txt_data_nascimento" style="font-size: 16px;">
               
                </div>
                <div class="form-group">
                    <label> Escolaridade: </label>
                    <input type="text" class="form-control" id="txt_escolaridade" name="txt_escolaridade" placeholder="Digíte sua Escolaridade:" style="font-size: 16px;">
                
                    <label> Endereço: </label>
                    <input type="text" class="form-control" id="txt_endereco" name="txt_endereco" placeholder="Digíte seu Endereço:" style="font-size: 16px;">
                
                    <label> Cidade: </label>
                    <input type="text" class="form-control" id="txt_cidade" name="txt_cidade" placeholder="Digíte sua Cidade:" style="font-size: 16px;">

                    <label> País: </label>
                    <input type="text" id="txt_pais" name="txt_pais" class="form-control" placeholder="Digíte seu País:" style="font-size: 16px;">

                    <label> Deixe uma mensagem: </label>
                    <textarea class="form-control" id="txt_mensagem" name="txt_mensagem" style="font-size: 16px;"></textarea>
                </div>
            </div>
